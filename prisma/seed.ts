  ...
  const products = [
    {
      ...
      priceCents: 350,
      imageUrl: "/images/products/cookie-pepites-chocolat.jpg",
    ...
    },
    {
      ...
      priceCents: 380,
      imageUrl: "/images/products/cookie-beurre-noisette.jpg",
      categoryId: classiques.id,
      featured: false,
    },
    {
      ...
      priceCents: 390,
      imageUrl: "/images/products/cookie-double-chocolat.jpg",
    ...
    },
    {
      ...
      priceCents: 420,
      imageUrl: "/images/products/cookie-caramel-beurre-sale.jpg",
      categoryId: gourmands.id,
      featured: true,
    },
    {
      ...
      priceCents: 430,
      imageUrl: "/images/products/cookie-pistache-framboise.jpg",
      categoryId: gourmands.id,
      featured: false,
    },
    {
      ...
      priceCents: 400,
      imageUrl: "/images/products/cookie-vegan-flocons-avoine.jpg",
      categoryId: gourmands.id,
      featured: false,
    },
    {
      ...
      priceCents: 400,
      imageUrl: "/images/products/muffin-myrtille.jpg",
    ...
    },
    {
      ...
      priceCents: 450,
      imageUrl: "/images/products/brownie-noix-pecan.jpg",
      categoryId: patisseries.id,
      featured: true,
    },
    {
      ...
      priceCents: 1800,
      imageUrl: "/images/products/coffret-decouverte.jpg",
    ...
    },
    {
      ...
      priceCents: 3200,
      imageUrl: "/images/products/coffret-prestige.jpg",
      categoryId: coffrets.id,
      featured: true,
    },
  ];
  ...
  await prisma.store.createMany({
    data: [
      ...
      },
      {
        ...
        imageUrl: "/images/boutique-2.jpg",
        order: 2,
      },
      {
        ...
        imageUrl: "/images/boutique-3.jpg",
        order: 3,
      },
    ],
  });
